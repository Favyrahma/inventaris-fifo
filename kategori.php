                ...
                <tr class="<?= ($mode==='edit' && $id_edit==$k['id']) ? 'table-warning' : '' ?>">
                  ...
                  <td>
                    <div class="d-flex align-items-center gap-2">
                      <div class="rounded-circle bg-primary bg-opacity-10 text-primary d-flex
                  ...
                  <td class="text-muted small">
                    <?= $k['deskripsi'] ? htmlspecialchars($k['deskripsi']) : '<span class="fst-italic">—</span>' ?>
                  </td>
                  <td class="text-center">
                    <span class="badge badge-produk
                      <?= $k['jml_produk'] > 0 ? 'bg-primary' : 'bg-secondary' ?>">
                      <?= $k['jml_produk'] ?> produk
                    </span>
                  </td>
                  <td class="text-center">
                    <a href="?mode=edit&id=<?= $k['id'] ?>"
                       class="btn btn-outline-warning btn-sm" title="Edit">
                      <i class="bi bi-pencil"></i>
                    </a>
                    <a href="?mode=hapus&id=<?= $k['id'] ?>"
